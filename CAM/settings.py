...
SECRET_KEY = 'django-insecure-0+tfp&=33hyo5%g()#qw87@eba-sdv*s#w$jniq1dqiizs66mu'
...
WSGI_APPLICATION = 'CAM.wsgi.application'
...
'default': {
        ...
        'NAME': 'CAM',  # Or path to database file if using sqlite3.
